...
Public Class ZedGraphFrm
    ...
    Public Sub FillDataGraphVI(ByVal _Xval As Int64)
        ...
        If (_Xval > 0) And (_Xval <= ConnectionUSB.InterventiLetti.Length) Then
            ...
            lblIntV1Val.Text = GetVoltage(ConnectionUSB.InterventiLetti.IntItems(ConnectionUSB.InterventiLetti.Length - _Xval)._intV12_rms)
            lblIntV2Val.Text = GetVoltage(ConnectionUSB.InterventiLetti.IntItems(ConnectionUSB.InterventiLetti.Length - _Xval)._intV13_rms)
    ...
    Public Sub UpdateChartZ_XY()
        ...
        Dim V12_prec As Integer = 0
        Dim V13_prec As Integer = 0
        Dim V23_prec As Integer = 0
        For x = 0 To ConnectionUSB.InterventiLetti.Length - 1
            ...
            listV1.Add(x + 1, GetVoltage(ConnectionUSB.InterventiLetti.IntItems(ConnectionUSB.InterventiLetti.Length - 1 - x)._intV12_rms), "V1-2")
            listV2.Add(x + 1, GetVoltage(ConnectionUSB.InterventiLetti.IntItems(ConnectionUSB.InterventiLetti.Length - 1 - x)._intV13_rms), "V1-3")
            listV3.Add(x + 1, GetVoltage(ConnectionUSB.InterventiLetti.IntItems(ConnectionUSB.InterventiLetti.Length - 1 - x)._intV23_rms), "V2-3")
            V12_prec = GetVoltage(ConnectionUSB.InterventiLetti.IntItems(ConnectionUSB.InterventiLetti.Length - 1 - x)._intV12_rms)
            V13_prec = GetVoltage(ConnectionUSB.InterventiLetti.IntItems(ConnectionUSB.InterventiLetti.Length - 1 - x)._intV13_rms)
            V23_prec = GetVoltage(ConnectionUSB.InterventiLetti.IntItems(ConnectionUSB.InterventiLetti.Length - 1 - x)._intV23_rms)
